          ...
          <div className="w-full md:w-1/2 relative md:ml-8">
            <div className="relative h-64 md:h-96 rounded-lg overflow-hidden shadow-2xl bg-gradient-to-r from-hoopr-blue/20 to-hoopr-purple/20 backdrop-blur-sm border border-white/10">
              <iframe
                ...
                src="https://www.youtube.com/embed/ArU8xSZcf7k?autoplay=1&mute=0&loop=1&playlist=ArU8xSZcf7k&controls=1&vq=hd1080&enablejsapi=1&showinfo=0&rel=0&modestbranding=1&origin=http://localhost:5173"
                title="Platform Demo"
                frameBorder="0"
